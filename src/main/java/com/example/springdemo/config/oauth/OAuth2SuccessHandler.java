...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            AddUserRequest newUserRequest = new AddUserRequest();
            newUserRequest.setEmail((String) oAuth2User.getAttributes().get("email"));
            newUserRequest.setPassword("");

            userService.save(newUserRequest);
            user = userService.findByEmail((String) oAuth2User.getAttributes().get("email"));
//            user = user.update("reg-sns");
        }
